  ...
  return (
    <div className="space-y-6">
          ...
          <Controller
            ...
            render={({ field, fieldState }) => (
              <Field data-invalid={fieldState.invalid} className="space-y-2">
                <FieldLabel htmlFor="login-email" className="text-sm font-medium text-foreground/90">Email Address</FieldLabel>
                <Input
                  {...field}
                  id="login-email"
                  type="email"
            ...
            render={({ field, fieldState }) => (
              <Field data-invalid={fieldState.invalid} className="space-y-2">
                <div className="flex items-center justify-between">
                  <FieldLabel htmlFor="login-password" className="text-sm font-medium text-foreground/90">Password</FieldLabel>
                </div>
      ...
      <Button 
        ...
        className="w-full h-12 bg-background/30 border-white/10 hover:bg-background/50 hover:text-foreground text-muted-foreground rounded-xl transition-all flex items-center justify-center gap-3 backdrop-blur-sm"
      >
